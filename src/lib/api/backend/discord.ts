...
export function createAlertDiscordEmbed(
    ...
    return {
        ...
        description: 'Your target price has been reached! A Hetzner server matching your criteria is now available at or below your desired price.',
...
export function createTestDiscordEmbed(): DiscordEmbed {
    return {
        ...
        fields: [
            {
                name: '📋 Test Details',
                value: 'If you can see this message, your Discord webhook configuration is set up properly.',
                inline: false
            }
        ],
        footer: {
