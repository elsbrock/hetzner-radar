<script lang="ts">
	...
	const driveLedDurations = Array(6)
		.fill(0)
		.map(() => getRandomDuration());
	const driveLedDelays = Array(6)
		.fill(0)
		.map(() => getRandomDelay());
</script>
...
<div class={`server-icon ${className}`}>
	...
	>
		...
		<circle
			...
			stroke-width="1.5"
			class="blink-led"
			style="animation-duration: {redLedDuration}s; animation-delay: {redLedDelay}s"
		/>
		...
		<circle
			...
			fill="#22c55e"
			class="blink-led"
			style="animation-duration: {driveLedDurations[0]}s; animation-delay: {driveLedDelays[0]}s"
		/>
		<circle
			cx="425"
			cy="73"
			...
			fill="#22c55e"
			class="blink-led"
			style="animation-duration: {driveLedDurations[1]}s; animation-delay: {driveLedDelays[1]}s"
		/>
		...
		<circle
			...
			fill="#22c55e"
			class="blink-led"
			style="animation-duration: {driveLedDurations[2]}s; animation-delay: {driveLedDelays[2]}s"
		/>
		<circle
			cx="425"
			cy="100"
			...
			fill="#22c55e"
			class="blink-led"
			style="animation-duration: {driveLedDurations[3]}s; animation-delay: {driveLedDelays[3]}s"
		/>
		...
		<circle
			...
			fill="#22c55e"
			class="blink-led"
			style="animation-duration: {driveLedDurations[4]}s; animation-delay: {driveLedDelays[4]}s"
		/>
		<circle
			cx="425"
			cy="127"
			...
			fill="#22c55e"
			class="blink-led"
			style="animation-duration: {driveLedDurations[5]}s; animation-delay: {driveLedDelays[5]}s"
		/>
	</svg>
</div>
