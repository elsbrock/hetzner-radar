...
<section id="contact" class="mx-auto mt-10 max-w-7xl text-center">
	...
	<p class="mx-auto mb-8 text-gray-600 md:w-2/3 dark:text-gray-400">
		Have questions or need support? We'd love to hear from you! Whether it's about our new email
		alert feature, optimizing your server configurations, or any other aspect of <strong
			>Server Radar</strong
