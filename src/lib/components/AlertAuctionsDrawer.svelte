...
>
	...
	{#if alertId && !hidden}
			...
			<TableBody class="divide-y">
				...
				{:else if error}
					<TableBodyRow>
						<TableBodyCell colspan={3} class="py-4 text-center">
							<p class="text-gray-700 dark:text-gray-400">
								This alert was triggered before auction matching was implemented. No auction data is
		...
		<div class="space-y-2 text-xs leading-relaxed text-gray-400 dark:text-gray-500">
			...
			<p>
				Please note: Auctions may no longer be available as they can be purchased quickly. Prices
				shown include VAT based on your selection, but Hetzner's final price may vary.
			</p>
			<p>
