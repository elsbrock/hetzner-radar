...
<main class="p-8 bg-gray-50 dark:bg-gray-900">
    ...
    >
        ...
        <p
            class="mb-10 mx-auto md:w-2/3 text-center text-gray-600 dark:text-gray-400"
        >
            Watch a live demo of Server Radar's key features. See how easy it is
            to track server prices, filter by specs, and set up alerts to find
            the best deals on Hetzner auction servers.
        </p>
        <!--ARCADE EMBED START-->
        <div
