...
<main class="p-8">
	...
	<section class="mx-auto my-12 max-w-7xl text-center">
		...
		<p class="mb-5 text-lg text-gray-600 dark:text-gray-400">
			Explore our curated server configurations tailored to different usage scenarios. Find the best
		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
			...
			>
				...
				<p class="text-gray-600 dark:text-gray-400">
					Perfect for running large databases, virtual machines, and applications that require
			...
			>
				...
				<h3 class="mb-4 text-2xl font-bold text-gray-800 dark:text-gray-100">Backup Solutions</h3>
				<p class="text-gray-600 dark:text-gray-400">
					Ideal for storing backups and ensuring data redundancy, providing peace of mind for your
			...
			>
				...
				<h3 class="mb-4 text-2xl font-bold text-gray-800 dark:text-gray-100">Game Servers</h3>
				<p class="text-gray-600 dark:text-gray-400">
					Host multiplayer game servers with low latency and reliable performance to ensure a smooth
					gaming experience.
				</p>
			</div>
			...
			>
				...
				<h3 class="mb-4 text-2xl font-bold text-gray-800 dark:text-gray-100">Cloud Applications</h3>
				<p class="text-gray-600 dark:text-gray-400">
					Deploy scalable cloud applications that can handle varying workloads with ease and
					flexibility.
				</p>
			</div>
			...
			>
				...
				<h3 class="mb-4 text-2xl font-bold text-gray-800 dark:text-gray-100">Secure Hosting</h3>
				<p class="text-gray-600 dark:text-gray-400">
					Host your websites and applications with robust security measures to protect against
			...
			>
				...
				<p class="text-gray-600 dark:text-gray-400">
					Set up reliable and customizable development environments to streamline your software
					development process.
				</p>
			</div>
		</div>
